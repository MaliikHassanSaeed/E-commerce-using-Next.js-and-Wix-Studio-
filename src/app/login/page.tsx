    ...
    try{
        ...
        switch (response?.loginState) {
            case LoginState.SUCCESS:
                setMessage("You are being successfully LoggedIn.")
       ...
       <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
        ...
        {mode===MODE.REGISTER ? (
            <div className="flex flex-col gap-2">
                ...
                <input type="text" name="username" placeholder="hassan" className="ring-2 ring-gray-300 rounded-md p-4"
...

{
    mode !== MODE.EMAIL_VERIFICATION ?(
        ...
        <input type="email" name="email" placeholder="Enter Your Email" className="ring-2 ring-gray-300 rounded-md p-4"
...
}
{
    ...
    <button className="bg-[#F35C7A] text-white p-2 rounded-md disabled:bg-pink-200 disabled:cursor-not-allowed" disabled={isLoading}>{isLoading ? "Loading..." : buttonTitle}</button>
