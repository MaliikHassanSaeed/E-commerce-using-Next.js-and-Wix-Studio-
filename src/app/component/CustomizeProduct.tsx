    ...
    <div className="flex flex-col gap-6">
     {productOptions.map((option)=>(
       ...
       <ul className="flex items-center gap-3">
        ...
        return option.name === "color" ?(  <li className="w-8 h-8 rounded-full ring-1 ring-gray-300  relative " style={{backgroundColor:choice.value , cursor:disabled? "not-allowed":"pointer"}}
